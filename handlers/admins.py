...
async def pause(_, message: Message):
    ...
    await message.reply_text("**تم الايقاف مؤقتا ▶**")
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**⌔∮ لم يتم تشغيل اي شيء لعمل تخطي له**")
    else:
    ...
    await message.reply_text("**⪼ تم تخطي المقطع الصوتي الحالي بنجاح**")
